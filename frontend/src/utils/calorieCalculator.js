/**
 * Frontend Calorie Calculation Utility
 * 
 * Mirrors the backend calorie calculation for real-time preview
 */
...
/**
 * Calculate calories burned for a workout (frontend version)
 ...
 */
export const calculateCalories = (workoutData) => {
 ...
 */
export const getCalorieIntensity = (calories, duration) => {
...
/**
 * Get color for calorie display based on intensity
 * @param {number} calories - Number of calories
 * @param {number} duration - Duration in minutes
 * @returns {string} CSS color class
 */
export const getCalorieColor = (calories, duration) => {
    const intensity = getCalorieIntensity(calories, duration);
    
    switch (intensity) {
        case 'Very High': return '#ff4444';  // Red
        case 'High': return '#ff8800';       // Orange
        case 'Moderate': return '#ffaa00';   // Yellow-orange
        case 'Low': return '#88cc00';        // Green
        case 'Very Low': return '#00aa88';   // Teal
